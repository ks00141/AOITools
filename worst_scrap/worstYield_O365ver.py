...
if admin_flag == 0:
    ...
    date = datetime.datetime.now().strftime(f"[%Y-%m-{admin_param}]")
...
cursor = driver.find_elements_by_xpath('//div[@class = "_1bVZQZoqR8bXQm6sTkfm1W"]/div[2]/div/span')
for i in range(3):
    for title in cursor:
